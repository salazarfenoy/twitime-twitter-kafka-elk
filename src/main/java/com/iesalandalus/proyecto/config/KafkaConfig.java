package com.iesalandalus.proyecto.config;
...
import com.iesalandalus.proyecto.utils.Constants;
...
public class KafkaConfig {
	...
	public ConsumerFactory<String, String> consumerFactory() {
		...
		props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, env.getProperty(Constants.KAFKA_AUTO_OFFSET_RESET));
